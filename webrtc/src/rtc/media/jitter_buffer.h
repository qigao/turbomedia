 ...
 */
TURBO_MEDIA_API jitter_buffer_t *jitter_buffer_create(uint32_t clock_rate, uint32_t target_delay_ms,
                                                size_t slot_size);

/**
 * Destroy jitter buffer
 */
TURBO_MEDIA_API void jitter_buffer_destroy(jitter_buffer_t *jb);

/**
 * Reset jitter buffer state
 */
TURBO_MEDIA_API void jitter_buffer_reset(jitter_buffer_t *jb);
 ...
 */
TURBO_MEDIA_API int jitter_buffer_put(jitter_buffer_t *jb, const rtp_packet_t *pkt, uint64_t now_ms);
 ...
 */
TURBO_MEDIA_API int jitter_buffer_get(jitter_buffer_t *jb, uint8_t *data, size_t max_len, size_t *len,
 ...
 */
TURBO_MEDIA_API int jitter_buffer_get_ex(jitter_buffer_t *jb, uint8_t *data, size_t max_len, size_t *len,
 ...
 */
TURBO_MEDIA_API int jitter_buffer_peek(jitter_buffer_t *jb, uint32_t *timestamp);

/**
 * Get current delay estimate in milliseconds
 */
TURBO_MEDIA_API uint32_t jitter_buffer_get_delay(const jitter_buffer_t *jb);

/**
 * Get estimated jitter in milliseconds
 */
TURBO_MEDIA_API uint32_t jitter_buffer_get_jitter(const jitter_buffer_t *jb);

/**
 * Get number of packets currently buffered
 */
TURBO_MEDIA_API int jitter_buffer_get_count(const jitter_buffer_t *jb);

/**
 * Check if jitter buffer is empty
 */
TURBO_MEDIA_API int jitter_buffer_is_empty(const jitter_buffer_t *jb);
 ...
 */
TURBO_MEDIA_API int jitter_buffer_get_missing(jitter_buffer_t *jb, uint16_t *missing, int max_count);

/**
 * Set adaptive delay bounds
 */
TURBO_MEDIA_API void jitter_buffer_set_delay_bounds(jitter_buffer_t *jb, uint32_t min_ms,
                                              uint32_t max_ms);
